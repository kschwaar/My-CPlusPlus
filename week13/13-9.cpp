...
int main(){
	...
	*/
	...
	cout << "Testing all_of:" << endl;
	if(all_of(Hundred.begin(), Hundred.end(), [](pair<int,string> i){return i.first>75;})){
		cout << "All numbers in HUNDRED are greater than 75." << endl;
	}
	if(all_of(Fifty.begin(), Fifty.end(), [](pair<int,string> i){return i.first>75;})){
		cout << "All numbers in FIFTY are greater than 75." << endl;
	}
}
